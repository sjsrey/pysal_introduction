...
\author{Sergio J. Rey}
\thanks{Recent development of PySAL has been supported by Award
No. 2009-SQ-B9-K101 from the National Institute of Justice, Office of
Justice Programs and National Science Foundation Grant OCI-1047916.}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=\linewidth]{src/gs_variablesentered.png}
\end{center}
...
%Code to reproduce the empirical illustration presented in this chapter
%is available at
%\url{https://github.com/sjsrey/pysal_introduction/blob/master/src/illustration.ipynb}.
\end{document}
